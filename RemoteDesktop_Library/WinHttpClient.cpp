...
const BYTE *WinHttpClient::GetRawResponseContent()
{
	return m_pResponse;
}

unsigned int WinHttpClient::GetRawResponseContentLength()
{
	return m_responseByteCount;
}

unsigned int WinHttpClient::GetRawResponseReceivedContentLength()
{
